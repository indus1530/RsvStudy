...
public class Section03Activity extends AppCompatActivity {
    ...
    private void SaveDraft() throws JSONException {
        ...
        SC.put("RS27a", bi.RS27a.isChecked() ? "1" : "0");
        SC.put("RS27b", bi.RS27b.isChecked() ? "2" : "0");
        SC.put("RS27c", bi.RS27c.isChecked() ? "3" : "0");
        SC.put("RS27d", bi.RS27d.isChecked() ? "4" : "0");
        SC.put("RS27e", bi.RS27e.isChecked() ? "5" : "0");
        SC.put("RS27f", bi.RS27f.isChecked() ? "6" : "0");
        SC.put("RS27g", bi.RS27g.isChecked() ? "7" : "0");
        SC.put("RS27h", bi.RS27h.isChecked() ? "8" : "0");
        SC.put("RS27i", bi.RS27i.isChecked() ? "9" : "0");
        SC.put("RS27j", bi.RS27j.isChecked() ? "10" : "0");
        SC.put("RS27k", bi.RS27k.isChecked() ? "11" : "0");
        SC.put("RS27l", bi.RS27l.isChecked() ? "12" : "0");
        SC.put("RS27m", bi.RS27m.isChecked() ? "13" : "0");
        SC.put("RS27n", bi.RS27n.isChecked() ? "14" : "0");
        SC.put("RS27o", bi.RS27o.isChecked() ? "15" : "0");
        SC.put("RS27p", bi.RS27p.isChecked() ? "16" : "0");
        SC.put("RS27q", bi.RS27q.isChecked() ? "17" : "0");
        SC.put("RS27r", bi.RS27r.isChecked() ? "18" : "0");
        SC.put("RS27s", bi.RS27s.isChecked() ? "19" : "0");
        SC.put("RS27t", bi.RS27t.isChecked() ? "20" : "0");
        SC.put("RS2796", bi.RS2796.isChecked() ? "96" : "0");
        SC.put("RS2796x", bi.RS2796x.getText().toString());

        SC.put("RS28a", bi.RS28a.isChecked() ? "1" : "0");
        SC.put("RS28b", bi.RS28b.isChecked() ? "2" : "0");
        SC.put("RS28c", bi.RS28c.isChecked() ? "3" : "0");
        SC.put("RS28d", bi.RS28d.isChecked() ? "4" : "0");
        SC.put("RS28e", bi.RS28e.isChecked() ? "5" : "0");
        SC.put("RS28f", bi.RS28f.isChecked() ? "6" : "0");
        SC.put("RS28g", bi.RS28g.isChecked() ? "7" : "0");
        SC.put("RS28h", bi.RS28h.isChecked() ? "8" : "0");
        SC.put("RS28i", bi.RS28i.isChecked() ? "9" : "0");
        SC.put("RS28j", bi.RS28j.isChecked() ? "10" : "0");
        SC.put("RS28k", bi.RS28k.isChecked() ? "11" : "0");
        SC.put("RS28l", bi.RS28l.isChecked() ? "12" : "0");
        SC.put("RS28m", bi.RS28m.isChecked() ? "13" : "0");
        SC.put("RS2896", bi.RS2896.isChecked() ? "96" : "0");
