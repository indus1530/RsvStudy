...
public class FormsList extends Activity {
    ...
    @BindView(edu.aku.hassannaqvi.rsvstudy.R.id.totalForms)
    TextView totalForms;
    @BindView(edu.aku.hassannaqvi.rsvstudy.R.id.completeForms)
    TextView completeForms;
    @BindView(edu.aku.hassannaqvi.rsvstudy.R.id.psuNoTxt)
    TextView psuNoTxt;
    @BindView(edu.aku.hassannaqvi.rsvstudy.R.id.FormsList)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(edu.aku.hassannaqvi.rsvstudy.R.layout.activity_forms_list);
